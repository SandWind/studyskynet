...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_search_2eproto = {
  false, false, 100, descriptor_table_protodef_search_2eproto, "search.proto", 
  &descriptor_table_search_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_search_2eproto::offsets,
  file_level_metadata_search_2eproto, file_level_enum_descriptors_search_2eproto, file_level_service_descriptors_search_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_search_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_search_2eproto);
  return descriptor_table_search_2eproto.file_level_metadata[index];
}
